...
data = [
  ...
  ['Charlotte', 6, 3, 4, 3, 5, 4, 4, 5, 4, 4, 3, 4, 5, 4, 4, 4, 3, 5]
]
...
if not hole1 == 0:
  for index, player_row in score_card.iterrows():
    ...
    score_board_df.loc[score_board_df['Player'] == player_name, 'Score'] = score_board_df.loc[score_board_df['Player'] == player_name, 'Score'] + player_score
